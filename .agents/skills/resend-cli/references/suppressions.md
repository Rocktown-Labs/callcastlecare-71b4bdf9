...
> **Beta:** Suppressions is a pre-GA feature gated per account. Commands appear in `--help` but return an API error unless the suppression list is enabled for your account. Reach out to Resend to join the beta.
