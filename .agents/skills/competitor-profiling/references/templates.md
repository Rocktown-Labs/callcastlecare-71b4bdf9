...
**Headline**: "[exact homepage headline]" **Subheadline**: "[exact subheadline]" **Positioning angle**: [1-2 sentence summary of how they position]
...
**Generated**: [date] **Your product**: [name] **Competitors profiled**: [count]
