import { defaultStripeCatalogItems, defaultStripeCoupons } from '@callcastlecare/api';
import type { StripeCatalogItemInput, StripeCouponInput } from '@callcastlecare/api';
