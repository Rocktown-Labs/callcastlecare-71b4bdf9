...
import { Calendar, Clock, Home, Shirt, Sprout } from "lucide-react";
...
const services = [
  { icon: Sprout, id: "lawncare", name: "Lawn care" },
  { icon: Shirt, id: "laundry", name: "Laundry" },
  { icon: Home, id: "homes", name: "Homes" },
] as const;
...
const bookingSchema = z.object({
  ...
  services: z.array(z.enum(["homes", "laundry", "lawncare"])).min(1),
    ...
    <section className="relative min-h-screen overflow-hidden bg-[#080c16] pt-18">
      ...
      <div className="relative mx-auto grid min-h-[calc(100svh-72px)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_460px] lg:px-8">
        <div className="max-w-3xl space-y-7">
          <div className="inline-flex items-center gap-2 border border-lime-300/30 bg-lime-300/10 px-3 py-1 text-sm font-medium text-lime-200">
            <span className="size-2 bg-lime-300" />
          ...
          <p className="max-w-2xl text-lg leading-8 text-white/65">
            Professional lawn care, laundry, and home services delivered with
        ...
        <form
          className="border border-white/10 bg-slate-950/75 p-5 shadow-2xl backdrop-blur"
        ...
        >
          ...
          <div className="mt-5 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              {services.map(({ icon: Icon, id, name }) => {
                const isSelected = selectedServices.includes(id);

                return (
                  <button
                    className={cn(
                      "flex min-h-24 flex-col items-center justify-center gap-2 border p-3 text-sm transition-colors",
                      isSelected
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  className="h-11 w-full border border-white/10 bg-white/[0.04] pl-10 pr-3 text-sm text-white outline-none focus:border-lime-300/50"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  className="h-11 w-full border border-white/10 bg-[#111827] pl-10 pr-3 text-sm text-white outline-none focus:border-lime-300/50"
          ...
          <Button
            className="mt-6 h-12 w-full bg-lime-300 text-base font-semibold text-slate-950 hover:bg-lime-200"
            type="submit"
          >
            Get quote
          </Button>
