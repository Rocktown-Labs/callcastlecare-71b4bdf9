...
const serviceHighlights = [
  ...
  { icon: Briefcase, label: "Skilled trades" },
] as const;
        ...
        <div className="max-w-3xl space-y-8">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-lg leading-8 text-white/65">
              Join the CallCastleCare network to provide premium lawn care,
              laundry, and home services on your schedule. Keep up to{" "}
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link to="/login">
              <Button
                className="h-12 bg-lime-300 px-6 text-sm font-semibold text-slate-950 hover:bg-lime-200"
                size="lg"
              >
                Start earning today
            ...
            <a href="#requirements">
              <Button
                className="h-12 border-white/20 bg-transparent px-6 text-sm text-white hover:bg-white/10"
                size="lg"
                variant="outline"
              >
                View requirements
