          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl font-black tracking-tight sm:text-4xl">
                Provider Holding Spot
              </h1>
              <p className="mt-2 max-w-2xl text-base leading-7 text-slate-600">
                Welcome to CastleCare! Your{" "}
                <strong>$50 Express Verification Fee</strong> is authorized, and
                your background check is currently being processed by our
                compliance team.
              </p>
            </div>
            <span
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  CastleCare admins review your background check, driving record
                  (MVR), vehicle specs, and ZIP code service radius.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="max-w-2xl">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                ...
                <strong>Stripe Connect</strong> onboarding button will unlock
                right here to link your bank account for instant job payouts!
              </p>
            </div>
            <Link
